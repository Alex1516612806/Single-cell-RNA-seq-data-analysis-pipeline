...
author: "Cankun Wang" "Shicong Wang"
...
# Change the directory to the download file path where you save that 'col-data-scrna.csv' and 'count-data-scrna.csv' file location.
knitr::opts_knit$set(root.dir = "C:/Users/Alex1/Desktop/scRNAseq-template-master/data")
...
This is a plot can be used to find cluster. The bigger the parameter, more precise of the resoultion.
```{r,echo=T,eval=T,message=T,warning=F,error=F}
...
[Single Cell RNA-Seq Analysis] (https://ucdavis-bioinformatics-training.github.io/2021-August-Single-Cell-RNA-Seq-Analysis/base/welcome)
